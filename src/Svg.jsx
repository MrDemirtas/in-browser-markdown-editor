...
export function TrashSvg() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#7C8187">
...
export function MoonSvg({ fillColor }) {
  return (
...
export function SunSvg({ fillColor }) {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill={fillColor}>
